    ...
    <body>		
				...
				<div class="span8">
					<div class="account pull-right">
						<ul class="user-menu">				
							...
							<li><a href="{{route('cart.index')}}">Your Cart &nbsp;<span class="badge">{{Cart::count()}}</span></a></li>
		...
		<div id="wrapper" class="container">
								...
								<div class="carousel-inner">
									<div class="active item">
										<ul class="thumbnails listing-products">
											<li class="span3">
												<div class="product-box">
													<span class="sale_tag"></span>												
													<img alt="" src="{{asset('frontend/themes/images/ladies/1.jpg')}}"><br/>
									...
									<div class="item">
										<ul class="thumbnails listing-products">
											<li class="span3">
												<div class="product-box">												
													<img alt="" src="{{asset('frontend/themes/images/ladies/2.jpg')}}"><br/>
							...
							<ul class="small-product">
								<li>
									<a href="#" title="Praesent tempor sem sodales">
										<img src="{{asset('frontend/themes/images/ladies/3.jpg')}}" alt="Praesent tempor sem sodales">
									</a>
									<a href="#">Praesent tempor sem</a>
								</li>
								<li>
									<a href="#" title="Luctus quam ultrices rutrum">
										<img src="{{asset('frontend/themes/images/ladies/4.jpg')}}" alt="Luctus quam ultrices rutrum">
									</a>
									<a href="#">Luctus quam ultrices rutrum</a>
								</li>
								<li>
									<a href="#" title="Fusce id molestie massa">
										<img src="{{asset('frontend/themes/images/ladies/5.jpg')}}" alt="Fusce id molestie massa">
									</a>
			...
			<section id="copyright">
				<span>Copyright 2018 tawfiq imam  All right reserved.</span>
			</section>
		</div>
