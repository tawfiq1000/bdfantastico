...
<html lang="en">
	<head>
		...
		<link href="{{asset('frontend/themes/css/jquery.fancybox.css')}}" rel="stylesheet"/>
		...
		<script src="{{asset('frontend/themes/js/jquery.fancybox.js')}}"></script>
			...
			<section class="main-content">				
				<div class="row">						
					<div class="span9">
						<div class="row">
							<div class="span4">
								<a href="{{asset('img/products/'.$product->slug.'.jpg')}}" class="thumbnail" data-fancybox-group="group1" title="Description 1"><img alt="" src="{{asset('img/products/'.$product->slug.'.jpg')}}"></a>												
								<ul class="thumbnails small">								
									<li class="span1">
										<a href="{{asset('img/products/'.$product->slug.'.jpg')}}" class="thumbnail" data-fancybox-group="group1" title="Description 2"><img src="{{asset('img/products/'.$product->slug.'.jpg')}}" alt=""></a>
									</li>								
							...
							<div class="span5">
								<address>
									...
									<strong>Key Feature:</strong> <span>{{$product->detail}}</span><br>
											...
											<ul class="thumbnails listing-products">
												...
												<li class="span3">
													<div class="product-box">
														...
														<a href="{{route('shop.show',$product->slug)}}"><img alt="" src="{{asset('img/products/'.$product->slug.'.jpg')}}"></a><br/>
								...
								<div class="carousel-inner">
									<div class="active item">
										<ul class="thumbnails listing-products">
											<li class="span3">
												<div class="product-box">
													<span class="sale_tag"></span>												
													<a href="product_detail.html"><img alt="" src="{{asset('frontend/themes/images/ladies/7.jpg')}}"></a><br/>
									...
									<div class="item">
										<ul class="thumbnails listing-products">
											<li class="span3">
												<div class="product-box">												
													<a href="product_detail.html"><img alt="" src="{{asset('frontend/themes/images/ladies/8.jpg')}}"></a><br/>
							...
							<ul class="small-product">
								<li>
									<a href="#" title="Praesent tempor sem sodales">
										<img src="{{asset('frontend/themes/images/ladies/1.jpg')}}" alt="Praesent tempor sem sodales">
									</a>
									<a href="#">Praesent tempor sem</a>
								</li>
								<li>
									<a href="#" title="Luctus quam ultrices rutrum">
										<img src="{{asset('frontend/themes/images/ladies/2.jpg')}}" alt="Luctus quam ultrices rutrum">
									</a>
									<a href="#">Luctus quam ultrices rutrum</a>
								</li>
								<li>
									<a href="#" title="Fusce id molestie massa">
										<img src="{{asset('frontend/themes/images/ladies/3.jpg')}}" alt="Fusce id molestie massa">
									</a>
